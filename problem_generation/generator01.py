...
'''
Used for generating setcover, indset, mknapsack, cautions
'''
...
if __name__ == '__main__':
    ...
    if args.problem == 'setcover':
        ...
        # train instances
        n = 111
        lp_dir = f'../problem_generation/data/setcover/train_new'
        ...
        # n = 100
        # lp_dir = f'../problem_generation/data/setcover/valid'
        # print(f"{n} instances in {lp_dir}")
        # os.makedirs(lp_dir)
        # filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        # nrowss.extend([nrows] * n)
        ...
        n = 50
        nrows = 500
        lp_dir = f'../problem_generation/data/setcover/small_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nrowss.extend([nrows] * n)
        ...
        n = 50
        nrows = 1000
        lp_dir = f'../problem_generation/data/setcover/medium_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nrowss.extend([nrows] * n)
        ...
        n = 50
        nrows = 2000
        lp_dir = f'../problem_generation/data/setcover/big_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nrowss.extend([nrows] * n)
        ...
        # train instances
        n = 111
        lp_dir = f'../problem_generation/data/indset/train_new'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ...
        # # validation instances
        # n = 100
        # lp_dir = f'../problem_generation/data/indset/valid'
        # print(f"{n} instances in {lp_dir}")
        # os.makedirs(lp_dir)
        # filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        # nnodess.extend([number_of_nodes] * n)
        ...
        n = 50
        number_of_nodes = 500
        lp_dir = f'../problem_generation/data/indset/small_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nnodess.extend([number_of_nodes] * n)
        ...
        lp_dir = f'../problem_generation/data/indset/medium_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nnodess.extend([number_of_nodes] * n)
        ...
        lp_dir = f'../problem_generation/data/indset/big_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nnodess.extend([number_of_nodes] * n)
        ...
        # train instances
        n = 111
        lp_dir = f'../problem_generation/data/cauctions/train_new'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ...
        # # validation instances
        # n = 100
        # lp_dir = f'../problem_generation/data/cauctions/valid'
        # print(f"{n} instances in {lp_dir}")
        # os.makedirs(lp_dir)
        # filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        # nitemss.extend([number_of_items] * n)
        ...
        number_of_items = 100
        number_of_bids = 500
        lp_dir = f'../problem_generation/data/cauctions/small_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nitemss.extend([number_of_items] * n)
        ...
        number_of_items = 200
        number_of_bids = 1000
        lp_dir = f'../problem_generation/data/cauctions/medium_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nitemss.extend([number_of_items] * n)
        ...
        number_of_items = 300
        number_of_bids = 1500
        lp_dir = f'../problem_generation/data/cauctions/big_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nitemss.extend([number_of_items] * n)
        ...
        # train instances
        n = 111
        lp_dir = f'../problem_generation/data/facilities/train_new'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ...
        # # validation instances
        # n = 100
        # lp_dir = f'../problem_generation/data/facilities/valid'
        # print(f"{n} instances in {lp_dir}")
        # os.makedirs(lp_dir)
        # filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        # ncustomerss.extend([number_of_customers] * n)
        ...
        number_of_customers = 100
        number_of_facilities = 100
        lp_dir = f'../problem_generation/data/facilities/small_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ncustomerss.extend([number_of_customers] * n)
        ...
        lp_dir = f'../problem_generation/data/facilities/medium_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ncustomerss.extend([number_of_customers] * n)
        ...
        lp_dir = f'../problem_generation/data/facilities/big_transfer'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        ncustomerss.extend([number_of_customers] * n)
