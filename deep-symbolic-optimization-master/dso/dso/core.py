...
class DeepSymbolicOptimizer():
    ...
    def setup(self):
        ...
        self.validpath = self.config_training["valid_path"]
    ...
    def train_one_step(self, override=None):
        ...
        if self.trainer.done:
            print(f"best exp: {repr(self.trainer.p_a_best.sympy_expr)}")
            return self.finish()
    ...
    def make_output_file(self):
        ...
        if self.config_experiment["logdir"] is None:
            self.save_path = None
